...
export default function OrderScreen() {
  ...
  //reducer function
  const params = useParams(); // use the params to get the order id from the url
  ...
  //function for paypal create, approve and error
  ...
  useEffect(() => {
    ...
    if (!order._id || successPay || (order._id && order._id !== orderId)) {
      ...
      const loadingPaypalScript = async () => {
        ...
        //dispatch paypal reducer script
        paypalDispatch({
          type: "resetOptions",
      ...
      <Row>
        ...
        <Col md={4} >
          <Card className="mb-3">
            ...
            <Card.Title>Shipping Price </Card.Title>
            <ListGroup variant="flush">
              <ListGroup.Item>
                <Row>
                  <Col>Tax</Col>
